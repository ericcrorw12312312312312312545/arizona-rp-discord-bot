...
module.exports = async (bot, interaction, args) => {
    ...
    await bot.channels.cache.get("959064921621028874").send({ content: `<@${req_db.DiscordID}>, модератор ${interaction.member} [ID: ${interaction.member.id}] отклонил Ваш запрос на получение роли` })
