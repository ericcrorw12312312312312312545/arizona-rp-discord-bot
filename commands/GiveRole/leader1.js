...
module.exports = {
    ...
    run: async (bot, message, args) => {
        try {
            ...
            await member.roles.add("695387227445788712")

            let embed = new MessageEmbed()
            .setColor(16505678)
            .setDescription(`Модератор **${message.author}** \`[ID: ${message.author.id}]\` выдал роль **<@&695387227445788712>** пользователю ${member} \`[ID: ${member.id}]\`.`)
