...
module.exports = {
    ...
    run: async (bot, message, args) => {
        try {
            ...
            await member.roles.add("897904018767118418")

            let embed = new MessageEmbed()
            .setColor(16505678)
            .setDescription(`Модератор **${message.author}** \`[ID: ${message.author.id}]\` выдал роль **<@&897904018767118418>** пользователю ${member} \`[ID: ${member.id}]\`.`)
