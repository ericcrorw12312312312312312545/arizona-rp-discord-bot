...
module.exports = {
    ...
    run: async (bot, message, args) => {
        try {
            ...
            await member.roles.remove("695387228746154025")

            let embed = new MessageEmbed()
            .setColor(16505678)
            .setDescription(`Модератор **${message.author}** \`[ID: ${message.author.id}]\` снял роль **<@&695387228746154025>** пользователю ${member} \`[ID: ${member.id}]\`.`)
